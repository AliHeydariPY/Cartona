...
start python manage.py runserver_plus --cert-file localhost.crt --key-file localhost.key

echo ⏰ Starting RQ Scheduler...
start python manage.py rqscheduler

echo ⚙️ Starting RQ Worker...
start python manage.py rqworker default scheduled

echo ⚙️ Starting Celery worker...
start celery -A store worker --loglevel=info
